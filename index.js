...
function addArtist(arr) {
  ...
  arr.push({
    id: 20,
    name: "Deavy Cristobal",
    years: "2000 - 2021",
    genre: "Web Design",
    nationality: "American",
    bio:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet odio molestiae",
  });
  return arr;
}
...
function lotsOfArt(arr) {
  /*Your Code Here*/
  const _100paintingArtists = [];
  for (let i = 0; i < arr.length; i++) {
    if (arr[i].paintings > 100) {
      _100paintingArtists.push(arr[i].name);
    }
  }
  return _100paintingArtists;
}
