...
1. How would you describe acessibility on the web to someone new to programming?
   accessiblity is how easy your website is to navigate for people with different devices, screen sizes etc.
2. Talk about 3 different things you can do to ensure your website is accessible.  
   you can do a css reset to make sure your website looks the same on all browsers
   you can make it responsive so it fits on all screens
   add "alt" attributes to all image tags in case it can't be viewed
3. How would you explain the concept of a variable to someone new to programming?
   a variable is a word to store a value for you to use later
4. What is the purpose of using functions in code?
   a function is a set of statements that can be used more than once for differing arguments
